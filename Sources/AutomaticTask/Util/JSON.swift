...
//  ProjectConfusion
//
//  Created by zhouziyuan on 2022/10/10.
//
...
extension JSONError: CustomNSError {
    ...
    public static var errorDomain: String { return "com.JSON.JSON" }
...
public struct JSON {
    ...
    /// 以文件路径创建JSON
    public init(url: URL, options opt: JSONSerialization.ReadingOptions = []) throws {
